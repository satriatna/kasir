...
@section('content')
<title>Tambah Distributor - Toko Buku</title>
    ...
    @endif
        <div class="card shadow mb-4">
            <div class="card-header">
                <h6 class="font-weight-bold text-primary">Tambah Distributor</h6>
            </div>
            <div class="card-body">
                ...
                @csrf
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="namaDist" id="namaDist" value="{{old('namaDist')}}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="telepon" id="telepon" value="{{old('telepon')}}" required>
                    </div>
                    <div class="form-group">
